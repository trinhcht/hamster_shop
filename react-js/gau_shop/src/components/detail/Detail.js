...
export function Detail() {
    ...
    const handlePlus = () => {
        let quantity = document.getElementById("quantityPro").value
        if (quantity < product.quantity) {
            quantity++;
            document.getElementById("quantityPro").value = quantity;
        }
    }
    const handleMinus = () => {
        let quantity = document.getElementById("quantityPro").value
    ...
    const handleAddCart = async () => {
        const quantity=document.getElementById("quantityPro").value;
        if (quantity<=0){
            ...
            const cartDTO = {
                idPro: product.id,
                username: username,
                quantity: document.getElementById("quantityPro").value
            }
                                    ...
                                    <div className="row">
                                        ...
                                        <div className=" col-12 col-md-6 col-lg-4">
                                            <div className="details-pro">
                                                <h1 className="title-product p-3">{product.name}</h1>
                                                <div className="inventory_quantity">
                                                    <div className="thump-break">
                                                        <span className="mb-break inventory mx-4">
                                                            <span className="stock-brand-title">Số lượng : </span>
                                                            <span className="a-stock">
                                                                <span className="a-stock">{product.quantity}</span>
                                                            </span>
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="form-inline">
                                                    <div className="price-box clearfix">
                                                        <span className="special-price">
                                                            <span
                                                                className="price product-price mx-3">{VND.format(product.price)}</span>
                                                        </span>
                                                    </div>
                                                    <div className="form-product mx-4">
                                                ...
                                                <div className="khuyen-mai">
                                                    <div className="title">
                                                        <img width="64" height="64"
                                                             src="https://png.pngtree.com/png-vector/20190115/ourlarge/pngtree-png-free-buckle-more-icon-details-icon-more_icon-png-image_334054.jpg"
                                                             alt="infor"/>
                                            ...
                                            <div className="product-right">
                                                <div className="chinhsach-pro">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-12">
                                                            <div className="item">
                                                                <img width="40" height="40"
                                                                     src="https://www.shutterstock.com/image-illustration/free-shipping-icon-260nw-164173265.jpg"
                                                                     alt="Miễn phí vẫn chuyển"/>
                                                                <div className="text">
                                                                    <span className="title">Miễn phí vẫn chuyển</span>
                                                                    <span className="des">Cho tất cả đơn hàng trong nội thành Đà Nẵng</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-12">
                                                            <div className="item">
                                                                <img width="40" height="40"
                                                                     src="https://shopeeplus.com//upload/images/chinh-sach-doi-tra-hang-tai.png"
                                                                     alt="Miễn phí đổi trả"/>
                                                                <div className="text">
                                                                    <span className="title">Miễn phí đổi - trả</span>
                                                                    <span className="des">Đối với sản phẩm lỗi hoặc vận chuyển</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-12">
                                                            <div className="item">
                                                                <img width="40" height="40"
                                                                     src="https://cdn.xxl.thumbs.canstockphoto.com/old-phone-retro-telephone-vector-eps-10-file-easy-to-edit-eps-vector_csp86526788.jpg"
                                                                     alt="Hỗ trợ nhanh chóng"/>
                                                                <div className="text">
                                                                    <span className="title">Hỗ trợ nhanh chóng</span>
                                                                    <span className="des">Gọi Hotline: 0333333333 để được hỗ trợ ngay</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        {/*<div className="col-12">*/}
                                                        {/*    <div className="item">*/}
                                                        {/*        <img width="40" height="40"*/}
                                                        {/*             src="https://cuoihoihungthinh.com/wp-content/uploads/2021/09/icon-uu-dai.png"*/}
                                                        {/*             alt="Ưu đãi combo"/>*/}
                                                        {/*        <div className="text">*/}
                                        ...
                                        <div className="col-12 col-lg-12 col-xl-12">
                                            <div className="productRelate product-lq">
                                                <div className="group_title_index">
                                                    <h3 className="title p-4" style={{marginBottom: "-2rem"}}>
                                                                                    ...
                                                                                    <div className="product-thumbnail">
                                                                                        ...
                                                                                        <div className="product-info">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                {value.quantity>0? (<span className="compare-price">Số lượng : {value.quantity}</span>):(<span className="compare-price">Hết hàng</span>)}
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
