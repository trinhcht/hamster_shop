...
public class UserPrinciple implements UserDetails {
    ...
    public static UserPrinciple build(AccountUser user) {
        List<GrantedAuthority> authorities = user.getRoles().stream().map(role -> new SimpleGrantedAuthority(role.getNameRoles())).collect(Collectors.toList());
